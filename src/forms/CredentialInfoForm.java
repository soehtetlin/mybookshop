...
public class CredentialInfoForm {
	...
	private void initialize() {
		...
		Image img = new ImageIcon(this.getClass().getResource("/img1.png")).getImage().getScaledInstance(275, 343, Image.SCALE_SMOOTH);
...
//		imageIcon = new ImageIcon(new ImageIcon(photo.toString()).getImage().getScaledInstance(160, 115, Image.SCALE_SMOOTH));
		...
		gl_imgPanel.setVerticalGroup(
			gl_imgPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_imgPanel.createSequentialGroup()
					.addComponent(lblImage, GroupLayout.DEFAULT_SIZE, 410, Short.MAX_VALUE)
					.addContainerGap())
		);
